...
var CanvasEventEmitter = function CanvasEventEmitter(target, eventSource) {
  ...
  ['click', 'mousedown', 'mouseup', 'mousemove', 'mouseover'].forEach(function(elem) {
  ...
  eventSource.addEventListener('mouseout', function(e) {
    that.emit('mouseout', e);
  });
...
CanvasEventEmitter.prototype._emitCanvasEvent = function(e, overrideType) {
  ...
  if (EventEmitter.listenerCount(this, overrideType || e.type) === 0) {
    return;
  }
